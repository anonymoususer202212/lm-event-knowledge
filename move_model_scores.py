"""
Move files from model score creation directory (XXX) to model_score directory
"""
...
for exp in ['ev1', 'new-EventsAdapt', 'dtfit']:
    ...
    files = [f for f in glob.glob(f'XXX/results/ANNs/*.txt', recursive=True) if re.search(pat, f)]
